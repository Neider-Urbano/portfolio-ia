  ...
  return (
    <div className="flex flex-wrap gap-3">
      {email && (
        <a
          href={`mailto:${email}`}
          className="group flex items-center gap-2.5 rounded-sm border border-line px-4 py-2.5 font-mono text-sm text-ink-muted transition-colors hover:border-signal hover:text-signal"
        >
