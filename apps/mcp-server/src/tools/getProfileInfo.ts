...
export const getProfileInfoTool: ToolDefinition = {
  ...
  description:
    "Obtiene la información personal y profesional principal del perfil: nombre, titular (headline), biografía, ubicación, contacto, años totales de experiencia, edad, hobbies, idiomas y enlaces sociales. Úsala para preguntas generales como '¿quién eres?', '¿dónde vives?', '¿cuántos años tienes?', '¿cuáles son tus hobbies?' o '¿qué idiomas hablas?'.",
  inputSchema: {},
  handler: async () => {
